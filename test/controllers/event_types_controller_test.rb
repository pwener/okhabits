...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { description: @event_type.description, name: @event_type.name, points: @event_type.points }
    end
  ...
  test "should update event_type" do
    patch :update, id: @event_type, event_type: { description: @event_type.description, name: @event_type.name, points: @event_type.points }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
